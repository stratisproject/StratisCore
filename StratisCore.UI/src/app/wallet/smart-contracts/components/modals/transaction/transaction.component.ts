...
export class TransactionComponent implements OnInit {
  ...
  @Input() actionButtonText = undefined;
  walletName: string;
  ...
  get titleText(): string { return this.title || `${this.prefixText} Contract`; }
  get buttonText(): string { return this.actionButtonText || `${this.prefixText} Contract`; }
